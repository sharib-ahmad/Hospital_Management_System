    ...
    >
      <div class="h-full flex flex-col">
          ...
          <RouterLink
            ...
            :class="
              $route.path === item.href
                ...
                : 'text-gray-600 hover:bg-gray-50 dark:text-slate-400 dark:hover:bg-slate-700/50 hover:text-gray-900 dark:hover:text-white'
            "
          >
        ...
        <div class="p-4 border-t border-gray-100 dark:border-slate-700">
          <button
            @click="handleLogout"
            class="flex w-full items-center gap-3 px-3 py-2 text-sm font-medium text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-colors"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5"
