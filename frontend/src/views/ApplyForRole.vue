...
const selectedRole = ref<'doctor' | 'nurse' | 'patient' | 'pharmacist' | null>(null)
...
const roles = [
  ...
  },
  {
    ...
    description: 'Manage medicine inventory, dispense prescriptions, and process pharmacy orders.',
...
const selectRole = (roleId: 'doctor' | 'nurse' | 'patient' | 'pharmacist') => {
