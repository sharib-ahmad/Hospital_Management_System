...
const enter = (el: any) => {
  ...
  htmlEl.style.transition = 'height 300ms cubic-bezier(0.4, 0, 0.2, 1), opacity 300ms ease'
  ...
  <div class="space-y-4">
    ...
    <div class="flex gap-4 mb-8">
      ...
      >
        ...
        >
          <path
            d="M23 4v6h-6M1 20v-6h6M3.51 9a9 9 0 0114.85-3.36 10 10 0 0110.46 10.16M20.49 15a9 9 0 01-14.85 3.36 10 10 0 01-10.46-10.16"
          />
        </svg>
      </button>
    </div>
    ...
    >
      <div
        class="animate-spin rounded-full h-10 w-10 border-[3px] border-emerald-600 border-t-transparent mb-4"
      ></div>
    ...
    <div v-else class="grid gap-4">
      <div
        ...
        :key="dept.id"
        class="glass rounded-[2rem] border border-white/40 dark:border-white/5 hover:border-emerald-500/30 transition-all shadow-premium overflow-hidden group"
      >
        <!-- Collapsed View -->
        <div
        ...
        >
          <div v-show="selectedDept === dept.id" class="bg-gray-50/30 dark:bg-slate-900/30">
            <div class="p-8 space-y-6 border-t border-gray-100 dark:border-slate-800">
              <!-- Description -->
              <div>
                <p
                  class="text-[10px] font-black text-gray-400 dark:text-slate-500 uppercase tracking-widest mb-2"
                >
              ...
              <div class="grid grid-cols-2 gap-4">
                <div
                  class="p-4 rounded-2xl bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700/50 shadow-sm"
                >
                  <p
              ...
              <!-- Timestamps -->
              <div
                class="flex items-center justify-between text-[10px] font-black text-gray-400 uppercase tracking-widest pt-4 border-t border-gray-100 dark:border-slate-800"
              >
                <p>
                  Created:
                  <span class="text-gray-600 dark:text-slate-400 ml-1">{{
...
<style scoped>
/* Smooth slide transition managed via JS hooks */
</style>
